<%-- 
    Document   : detalles-pedido-contraentrega
    Created on : 14 nov 2025, 1:33:05 a.m.
    Author     : benja
--%>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="styles/detalles_pedido_contraentrega.css" />
                        ...
                        <div class="details-direction">
                            <div class="info-content">
                                ...
                                <div class="content-direction">
                                    ...
                                    <p>Ciudad Obregón</p>
                                    <p>Número de referencia: 123123123123</p>
                                </div>
                            </div>
                        </div>
                        <div class="payment-pending">
                            <p class="payment-acc">Realizarás tu pago cuando se te entregue
                                el paquete</p>
