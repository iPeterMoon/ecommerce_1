      ...
      <div class="address-form-container">
        ...
        <div class="form-content">
          ...
          <div class="form-group">
            ...
            <input type="text" id="addressName" placeholder="Ej: Casa, Oficina" />
          </div>
        ...
        <div class="form-buttons">
          <a href="shopping-cart.jsp" class="cancel-button">Cancelar</a>
          
          <button class="save-button" onclick="saveAddress(event)">Guardar</button>
        </div>
      </div>
    </main>

    <script src="scripts/agregar_direccion.js"></script>
