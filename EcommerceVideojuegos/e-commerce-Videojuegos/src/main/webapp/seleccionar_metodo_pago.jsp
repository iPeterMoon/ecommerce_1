    ...
    <main class="container">
        ...
        <div class="payment-method-container">
            ...
            <div class="methods-content">
                <a href="introducir_datos_bancarios.html"><button class="method-button">Tarjeta</button></a>
                <a href="detalles-pedido-transfe.html"><button class="method-button">Transferencia</button></a>
                <a href="detalles-pedido-contraentrega.html"><button class="method-button">Contra entrega</button></a>
            </div>
        </div>
    </main>
