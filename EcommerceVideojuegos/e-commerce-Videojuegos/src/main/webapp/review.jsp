        ...
        <main>
            ...
            <div class="modal-published" id="review-published-modal"> <!--modal simulado-->
                <div class="modal-content-published">
                    ...
                    <a href="index.html" class="btn-back-to-home">Volver al inicio</a>
                </div>
            </div>
        </main>
        ...
        <footer class="site-footer">
            <div class="footer-container">
                ...
                <div class="footer-column">
                    ...
                    <p>Tu universo de videojuegos. Encuentra los mejores títulos, ofertas y la comunidad más apasionada del gaming.</p>
                </div>
