<%-- 
    Document   : detalles-pedido-transfe
    Created on : 14 nov 2025, 1:34:26 a.m.
    Author     : benja
--%>
...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="styles/detalles_pedido-transfe.css" />
          ...
          <div class="details-container">
            <div class="details-info">
              ...
              <div class="payment-pending">
                <p>Para realizar tu pago haz transferencia a la siguiente cuenta:</p>
                <p class="payment-acc">1234 1234 1234 1234</p>
              </div>
            </div>

            <div class="details-game">
              <img
                src="https://preview.redd.it/new-minecraft-art-cover-what-do-you-think-v0-jncj9eqr9bad1.jpeg?auto=webp&s=8ba0359485474ee23ca522d0fdddb59bdec9c250"
            ...
            <div class="details-price">
              ...
              <div class="payment-status rightdetail">
                <p>Estado pago:</p>
                <p class="pending righty">Pendiente</p>
              </div>
              <div class="continue-shopping rightdetail">
                <a href="index.html" class="righty btnKeepShp">Seguir comprando</a>
              </div>
            </div>
          </div>
        </div>
